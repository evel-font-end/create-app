 ...
 * 获取成交审核列表
 */
export const getCheckMineTargetList = ({ data, pageNo, pageSize, sorting }) => {
  const fromData = {
    data: { ...data }, // 查询信息
  ...
  return api.request({
    method: "post",
    url: "/api/trade/checkMineTargetList",
    data: fromData
  });
};
/**
 ...
 * 查询标的详情
 *  */ 
export const getTransMineTargetInfo = (id) => {
  return api.request({
    method: 'get',
    url: '/api/transMineTarget/' + id
  })
}
/**
 * 获取申请标的交易记录详情
