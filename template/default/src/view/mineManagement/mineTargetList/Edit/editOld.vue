                ...
                <el-col :span="24">
                  <el-form-item label="绑定的交易物信息：" prop="goodsIds">
                    <el-table :data="Options.tableData" stripe style="width: 100%" size="mini">
                      <el-table-column label="矿区名称">
                        <template slot-scope="scope">
                          <div v-if="edit">{{scope.row.no}}</div>
                          <div v-else style="color: #5191FD;cursor:default;" @click="routeTo('look', {row: scope.row }, scope.row.goodsType)">{{scope.row.no}}</div>
                        </template>
                      </el-table-column>
                      <!-- <el-table-column prop="no" label="矿区名称"></el-table-column> -->
  ...
  data () {
    ...
    const validateBeginNotice = (rule, value, callback) => {
      if(value === ''){
        ...
        if(((this.pageType === 'infoTrans' && this.curr_btnStatusData.isRestart === 1) || this.pageType === 'add' || this.pageType === 'edit') && this.isUpdateDate) {
          ...
          // startDate.setDate(startDate.getDate()+this.dictionaryNoticeCode.getDate-1);
          // startDate.setHours(startDate.getHours()+this.dictionaryNoticeCode.getHours);
          // startDate.setMinutes(startDate.getMinutes()+this.dictionaryNoticeCode.getMinutes);
          // const endDate = startDate.getFullYear() + "-" + (('0' + (startDate.getMonth() + 1)).substr(-2)) + "-" + (('0' + startDate.getDate()).substr(-2)) + " "+ (('0' + startDate.getHours()).substr(-2)) + ":" + (('0' + startDate.getMinutes()).substr(-2)) + ":" + (('0' + startDate.getSeconds()).substr(-2));
          ...
          //   startDate2.setDate(startDate2.getDate()+this.dictionaryNoticeCode.getDate);
          //   startDate2.setHours(startDate.getHours()+this.dictionaryNoticeCode.getHours);
          //   startDate2.setMinutes(startDate.getMinutes()+this.dictionaryNoticeCode.getMinutes);
          //   const endDate2 = startDate2.getFullYear() + "-" + (('0' + (startDate2.getMonth() + 1)).substr(-2)) + "-" + (('0' + startDate2.getDate()).substr(-2)) + " "+ (('0' + startDate2.getHours()).substr(-2)) + ":" + (('0' + startDate2.getMinutes()).substr(-2)) + ":" + (('0' + startDate2.getSeconds()).substr(-2));
          //   this.formData.beginListTime = endDate2;
          //   this.formData.beginFocusTime = endDate2;

          //   //挂牌结束/自由报价结束/限时竞价开始
          //   const startDate3 = new Date((value).replace(/-/g,"/"));
          //   startDate3.setDate(startDate3.getDate()+this.dictionaryNoticeCode.getDate+this.dictionaryListCode.getDate-1);
          //   startDate3.setHours(startDate3.getHours()+this.dictionaryNoticeCode.getHours+this.dictionaryListCode.getHours);
          //   startDate3.setMinutes(startDate3.getMinutes()+this.dictionaryNoticeCode.getMinutes+this.dictionaryListCode.getMinutes);
          //   const endDate3 = startDate3.getFullYear() + "-" + (('0' + (startDate3.getMonth() + 1)).substr(-2)) + "-" + (('0' + startDate3.getDate()).substr(-2)) + " "+ (('0' + startDate3.getHours()).substr(-2)) + ":" + (('0' + startDate3.getMinutes()).substr(-2)) + ":" + (('0' + startDate3.getSeconds()).substr(-2));
          ...
          //   startDate4.setDate(startDate4.getDate()+this.dictionaryNoticeCode.getDate);
          //   startDate4.setHours(startDate4.getHours()+this.dictionaryNoticeCode.getHours);
          //   startDate4.setMinutes(startDate4.getMinutes()+this.dictionaryNoticeCode.getMinutes);
          //   this.formData.beginLimitTime = startDate4.getFullYear() + "-" + (('0' + (startDate4.getMonth() + 1)).substr(-2)) + "-" + (('0' + startDate4.getDate()).substr(-2)) + " "+ (('0' + startDate4.getHours()).substr(-2)) + ":" + (('0' + startDate4.getMinutes()).substr(-2)) + ":" + (('0' + startDate4.getSeconds()).substr(-2));
          // }
      ...
      if(value === ''){
        ...
        if(((this.pageType === 'infoTrans' && this.curr_btnStatusData.isRestart === 1) || this.pageType === 'add' || this.pageType === 'edit') && this.isUpdateDate) {
          ...
          if((this.formData.transType!='102')&&(this.formData.transType!='网上交易（拍卖）')){
            ...
            //挂牌结束/自由报价结束/限时竞价开始
            // const startDate3 = new Date((value).replace(/-/g,"/"));
            // startDate3.setDate(startDate3.getDate()+this.dictionaryListCode.getDate);
            // startDate3.setHours(startDate3.getHours()+this.dictionaryNoticeCode.getHours);
            // startDate3.setMinutes(startDate3.getMinutes()+this.dictionaryNoticeCode.getMinutes);
            const startDate3 = getTime(value, this.dictionaryListCode)
            const endDate3 = startDate3;
            this.formData.endListTime = endDate3;
            this.formData.endFocusTime = endDate3;
            this.formData.beginLimitTime = endDate3;
          }else{
      ...
      if((this.formData.transType!='102')&&(this.formData.transType!='网上交易（拍卖）')){
        if(value === ''){
          ...
          if(((this.pageType === 'infoTrans' && this.curr_btnStatusData.isRestart === 1) || this.pageType === 'add' || this.pageType === 'edit') && this.isUpdateDate) {
            ...
            const endDate = Date.parse(value.split(" ")[0]);
            if(endDate < startDate){
              callback(new Error('自由报价时间必须大于等于公告结束时间'))
            }
            this.formData.beginFocusTime = value;
            this.isDate.beginNoticeDate = false;
            this.isDate.endNoticeDate = false;
        ...
        if(value === ''){
          ...
          if(((this.pageType === 'infoTrans' && this.curr_btnStatusData.isRestart === 1) || this.pageType === 'add' || this.pageType === 'edit') && this.isUpdateDate) {
            ...
            if((this.formData.transType != '102')&&(this.formData.transType != '网上交易（拍卖）')){
              ...
              const endDate = Date.parse(value.split(" ")[0]);
              //拿到小时
              const endHours = parseInt(value.split(" ")[1].split(":")[0]);
              if(endDate < startDate){
    ...
    return {
      ...
      rules: {
        ...
        // requirePriceNum: [
        //   { required: true, message: '请输入出价人数', trigger: 'blur' }
        // ],
        earnestMoney: [
      ...
      getTransMineTargetInfo(id)
        .then(res => {
          if (res.code === '200') {
            ...
            this.selectBindList = res.data.transGoodsDtos;
