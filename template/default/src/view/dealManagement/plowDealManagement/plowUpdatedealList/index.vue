...
import {
  getCheckPlowTargetList,
  getSubmitDetermine
} from "@/api/dealManagement/plowDealManagement/plowUpdatedealList";
import {
  getSubmitTrade,
  getCancelTrade,
  getTransBook,
...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: "交易结束时间", prop: "endTransTime", width: '180px' },
  ...
  methods: {
    ...
    getList() {
      ...
      getCheckPlowTargetList(param).then(res => {
