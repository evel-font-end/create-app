    ...
    <div class="container">
        ...
        >
          <template slot-scope="scope" slot="operator">
            <el-button type="text" size="small" title="详情" icon="iconfont icon-feeds-fill" @click="toPage(scope.row.id,'infoTrans',scope.row)"></el-button>
          </template>
        </page-table>
...
} from '@/api/dealManagement/mineDealManagement/mineBreakdealList';
import {
  getTargetSuspend,
  getTargetStop
...
export default {
    ...
    data () {
      return {
        ...
        tableCols: [
          ...
          { label: '加价幅度（万元）', prop: 'priceStepText', minWidth: 150, align: 'right' },
          { label: '竞买申请人数', prop: 'applyNum', minWidth: 100 },
          { label: '状态', prop: 'statusText', width: '110px' },
          ...
          { label: '挂牌开始时间', prop: 'beginFocusTime', width: '180px' },
    ...
    methods: {
      ...
      getList () {
        ...
        getBreakTargetList(param).then(res => {
