...
function webViewerInitialized() {
  ...
  //validateFileURL(file); jxl-取消URL验证
...
var PDFPageView = function () {
  function PDFPageView(options) {
    ...
    div.id = 'pageContainer' + this.id; // modified
...
var PDFSidebar = function () {
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function open() {
      ...
      this.isOpen = true;
      this.toggleButton.classList.add('toggled');
      this.mainContainer.classList.add('sidebarMoving');
      this.mainContainer.classList.add('sidebarOpen');
    ...
    value: function close() {
      ...
      this.toggleButton.classList.remove('toggled');
      this.mainContainer.classList.add('sidebarMoving');
      this.mainContainer.classList.remove('sidebarOpen');
      this._forceRendering();
      this._dispatchEvent();
    }
  }, {
...
var PDFViewer = function () {
  ...
  _createClass(PDFViewer, [{
    ...
    value: function _setScaleUpdatePages(newScale, newValue) {
	  ...
	  createSealContainer(gPdfData); // jxl_
    }
  }, {
    key: '_setScale',
