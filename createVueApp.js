...
async function createVueApp(name, type = 'default') {
  ...
  switch (type) {
    case 'default':
      allDependencies = ['vue@2.6.10', 'vuex@3.1.2', 'vue-router@3.0.7', 'axios', 'babel-polyfill', 'element-ui', 'element-resize-detector', 'echarts@4.9.0', 'moment', 'jsencrypt', 'js-cookie', 'wangeditor', 'core-js@3.21.1', 'es6-promise', 'html2canvas@1.0.0-rc.7', 'print-js@1.6.0'];
      break;
    case 'vue3':
      allDependencies = [];
